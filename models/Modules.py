...
class DenseFusion(nn.Module):
    ...
    def forward(self, rgb, depth):
        # Sum both modalities before dense fusion.
...
class FeatureFusionAndPrediction(nn.Module):
    ...
    def forward(self,out_data_4,out_data_8,out_data_16,out_data_32):
        """Fuse four scales and predict a density map."""
        
        # Compress the 32x stage first.
        out_data_32 = self.basicconv1(out_data_32)
        out_data_32 = self.basicconv3(out_data_32)
        
        # Fuse features in a top-down path.
        ...
        # Upsample all scales before concatenation.
        ...
        # Regress a single-channel density map.
        out_data = self.reg_layer(out_data)

        # Keep the density non-negative.
