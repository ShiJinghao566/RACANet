...
def parse_args():
    ...
    parser.add_argument('--lambda-cons', type=float, default=0.1,
                        help='weight of 4-stage reliability consistency loss')
    parser.add_argument('--warmup-weights', type=str, default='',
                        help='optional warm-up checkpoint (.pth/.tar) to initialize partial weights')
    ...
    parser.add_argument('--val-start', type=int, default=9999,
                        help='the epoch start to val')
    parser.add_argument('--test-epoch', type=int, default=1,
                        help='the num of steps to test')
    parser.add_argument('--test-start', type=int, default=150,
