...
def parse_xml_points(xml_path):
    """Parse XML points as an (N, 2) float32 array."""
...
class Crowd_Drone(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Infrared matches the XML name; RGB drops a trailing R.
        ...
        if self.method == 'train':
            ...
            # Build a binary dot map for evaluation.
    ...
    def train_transform(self, RGB, T, keypoints):
        """Apply a random crop and shift points."""
        ...
        # Shift points into the crop frame.
